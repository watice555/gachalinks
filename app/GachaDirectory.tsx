...
const sites: DirectorySite[] = [
  ...
  },
  {
    ...
    eyebrow: "多游戏版本资料库",
    description:
      "覆盖原神、星铁与绝区零的正式服及测试服资料，收录角色、武器装备、物品和教程，并通过更新日志与逐项对比展示版本变化。",
    monogram: "GB",
    accent: "#ff7f6e",
    games: ["原神", "星铁", "绝区零"],
    tags: [
    ...
    note: "可切换正式服与测试服分支；测试版本内容可能在实装前发生变化。",
  },
  {
    id: "honey-impact",
    index: "11",
  ...
  },
  {
    ...
    eyebrow: "原神文本搜索",
    description:
      "原神全文本检索工具，可按正式服、测试服与历史版本搜索对话或全部文本，支持中英对照、正则表达式、仅新增及已删除内容筛选。",
    monogram: "HD",
    accent: "#b8a4ff",
    games: ["原神"],
    tags: ["文本搜索", "版本数据", "版本对比"],
